...
![添加.png](../../../../_assets/images/d337bf58_FaxgN添加.png)
...
![合并.png](../../../../_assets/images/ba0fa95f_vbLBr合并.png)
...
![执行.png](../../../../_assets/images/4fc1d875_0i9l5执行.png)
...
![image.png](../../../../_assets/images/2f5200f6_HkO19image.png)
...
Buff编辑器预置了伤害型、异常状态、增益效果三大类型的Buff模板，各类型下提供了具体的Buff蓝图示例，开发者可以基于示例模板创建Buff蓝图进行二次定制；另外，提供了部分特化的 [功能型Buff](./20253_变参Buff模板.md) 供开发者直接使用，开发者也能够使用空模板制作全新的Buff效果。

![image.png](../../../../_assets/images/7b77eb61_ZUaJ9image.png)
...
![流血.gif](../../../../_assets/images/1be9f591_vx3Jn流血.gif)

【燃烧】

每秒受到25点伤害；Buff可叠加，最多叠加3层。

![燃烧.gif](../../../../_assets/images/f3ae4089_QXpzc燃烧.gif)

【定时炸弹】

给予角色一枚定时炸弹，炸弹3秒后爆炸，造成30伤害

![QQ20250408172311-ezgif.com-video-to-gif-converter.gif](../../../../_assets/images/c0966035_FOznNQQ20250408172311-ezgif.com-video-to-gif-converter.gif)
...
![冰冻.gif](../../../../_assets/images/024e36b5_E84aj冰冻.gif)

【荆棘束缚】

每秒受到15点伤害且无法移动，持续3秒。

![荆棘束缚.gif](../../../../_assets/images/00278cc6_VXeBS荆棘束缚.gif)

【眩晕】

造成3秒的眩晕，无法移动且无法使用技能。

![晕眩.gif](../../../../_assets/images/79c54f6e_WN3PO晕眩.gif)
...
![生命.gif](../../../../_assets/images/6f69ad8e_ZOOUE生命.gif)
...
![image.png](../../../../_assets/images/98c326eb_WXtWkimage.png)
...
![image.png](../../../../_assets/images/23100858_dhlsLimage.png)

在资源目录中搜索“UGC_DefaultMainUI”，或者在路径 ```和平精英/资源/UI资源/UI模板/战斗界面``` 下找到该控件蓝图，右键 ```复制引用路径```。

![image.png](../../../../_assets/images/0d7900e9_guxahimage.png)

打开 ```UGCPlayerController``` 蓝图，在属性栏中搜索“Main UIClass”，右键 ```粘贴``` 将控件蓝图赋予该属性。

![image.png](../../../../_assets/images/f64695ef_36uvsimage.png)

---

#### Buff基础信息

![image.png](../../../../_assets/images/ba36816a_ukvl1image.png)

- 生效时长：单层Buff的默认持续时间，设置<0的值代表永久生效，Buff实际时长受合并效果影响
- 类型Tags：通过 [GameplayTag](../../20102_Gameplay标签.md) 标记的Buff类型，适用于筛选和分类场景，遵循 [GameplayTag匹配规则](../../20102_Gameplay标签.md#GameplayTag匹配)
...
![Buff UI.jpg](../../../../_assets/images/3e2e1917_GT4HkBuff UI.jpg)
![image.png](../../../../_assets/images/6d80d4a2_R8sB4image.png)
...
![image.png](../../../../_assets/images/20451714_VTNuAimage.png)
...
> 更多关于角色状态的概念及互斥逻辑关系可参考 [状态互斥](../20106_状态互斥.md) 文档
...
![image.png](../../../../_assets/images/1d407121_cagOfimage.png)
...
![image.png](../../../../_assets/images/46bfcf01_KwIaGimage.png)
...
![image.png](../../../../_assets/images/a194ea5a_PPXVYimage.png)

【触发时机】

支持Buff的开始/结束、间隔、堆叠时触发，支持复选时机条件，即同一动作可以在多种时机下被触发。

![image.png](../../../../_assets/images/a810e7a7_7FC3Jimage.png)
...
Buff编辑器预置了一批动作Action，各动作配置属性不同，可参考 [BuffAction查询手册](./20117_BuffAction查询手册.md) 部分内容。

![image.png](../../../../_assets/images/d1e18993_zfM5Timage.png)
...
技能编辑器提供了 [``添加Buff``](../技能编辑器2.0/20094_技能Task查询手册.md#技能Task-添加Buff) 和 [``移除Buff``](../技能编辑器2.0/20094_技能Task查询手册.md#技能Task-移除Buff) 的技能节点，配置在时间轴上，施放该技能时将在指定的时间点执行添加/移除Buff。

![image.png](../../../../_assets/images/bd1a156e_B4WFvimage.png)
