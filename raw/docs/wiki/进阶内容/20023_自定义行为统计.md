...
- PlayerKey：[玩家对局标识](./352_绿洲启元玩法开发框架介绍.md)，整型或留空，无效或非整型的PlayerKey会导致上报失败
...
![image.png](../_assets/images/989293a1_CK24jimage.png)

目前支持按日期时间段、玩法名、行为ID的查询条件，也支持以Excel的格式导出相关数据：

![image.png](../_assets/images/3b275c27_EShqHimage.png)
![image.png](../_assets/images/8afb25da_9CHFdimage.png)
