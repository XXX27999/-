...
![image.png](../../_assets/images/6fa7a466_hQIRDimage.png)

1. 进入枪火大厅后可进行模式/难度/是否自动匹配队友的选择。

![image.png](../../_assets/images/071524d6_cJjSZimage.png)

2. 需队友完成准备后，队长才可开始游戏，每次切换模式将自动重置准备状态。

![image.png](../../_assets/images/4707a751_xJ0JVimage.png)

3. 若勾选自动匹配队友，则会补充对应模式人数的队友进入战斗DS（阶段匹配功能生效除外），新增队友为临时队友，不加入枪火大厅的队伍关系。

![image.png](../../_assets/images/822530a7_7A4w3image.png)

4. 对局结束后返回枪火大厅，仍保留原和平大厅队伍关系。

![image.png](../../_assets/images/e04fefe3_NWVOkimage.png)
...
![image.png](../../_assets/images/7b612120_2LG3Iimage.png)
...
![image.png](../../_assets/images/b17558e9_5FEx7image.png)
