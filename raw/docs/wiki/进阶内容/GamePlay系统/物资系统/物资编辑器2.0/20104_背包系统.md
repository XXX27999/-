...
配合 [物品编辑器](./20101_物品编辑器.md) 构建的全新背包系统，区别于和平精英经典背包的单列布局结构，新背包采用网格布局的设计，加入了背包扩容的概念，在继承物品基础操作和可堆叠的功能上，支持持久化存储物品数据的能力，并扩展出装备栏和仓库的独立功能，使得新的背包系统更通用、扩展性更强，为开发者打造多元化的绿洲玩法提供能力支撑。

## 启用背包系统

为了兼容经典背包，新的背包系统通过 [GamePart](../../../../通用功能/20090_GamePart模块化.md) 提供模块化的启用方式，玩法默认使用经典背包，启用后被新背包替代。
> 旧 [物资编辑器](../物资编辑器1.0/185_概述.md) 的物资功能无法适配新背包，新背包需要与新 [物品编辑器](./20101_物品编辑器.md) 配套使用

点击编辑器菜单栏的【玩法通用设置】按钮，在弹出的 ``DA_GameModeGeneral`` 数据资产蓝图中的 ``Active Game Part Configs`` 属性下添加“GP_BackpackV2”模块，保存并 [启动调试](../../../../绿洲编辑器基础内容/调试游戏/307_编辑器Debug调试.md) 即可验证是否生效：

![image.png](../../../../_assets/images/5e81c316_Jj4BDimage.png)
![image.png](../../../../_assets/images/e321e4fe_PdoN7image.png)

## 自定义背包系统

完整的背包系统包含物品背包、装备栏和仓库三部分功能，开发者可以对各功能进行自定义设置，包括但不限于设置背包容量、解锁格子、配置装备槽位、启用仓库等等。

![image.png](../../../../_assets/images/ac018863_l0wWnimage.png)
...
![image.png](../../../../_assets/images/7bfa0f53_KCKsIimage.png)
...
![image.png](../../../../_assets/images/3c9316bc_Iu4PIimage.png)
![image.png](../../../../_assets/images/7ac76208_FVB9Wimage.png)

该组件蓝图自动被引用，且创建按钮变更为【打开】按钮，点击将自动打开 ``BP_BackpackComponentV2_Custom`` 蓝图编辑器窗口。

![image.png](../../../../_assets/images/50641ebe_vNDjCimage.png)
![image.png](../../../../_assets/images/966fdc68_wERfdimage.png)

### 自定义物品背包

物品背包的功能区域分为：排序规则、背包网格、物品页签、物品整理和扩容代币。

![image.png](../../../../_assets/images/eb17d36b_86eFAimage.png)
...
存储及操作物品的网格空间，可以设置网格的容量，支持代币解锁格子，每格可堆叠的物品数量受物品 [最大堆叠数量](./20101_物品编辑器.md#基础配置) 的影响；若格子被锁定，会显示解锁需要的代币及数量。
...
物品整理功能固定将同类的物品按 [可堆叠数量上限](./20101_物品编辑器.md#基础配置) 进行合并，减少对网格容量的占用。
...
![image.png](../../../../_assets/images/0c68c3d2_UiSeLimage.png)
![image.png](../../../../_assets/images/79aad9d5_M1wo4image.png)
...
![image.png](../../../../_assets/images/b34cfa3f_UyE0Himage.png)
...
- TabName：页签的名称
- Tags：带有指定 [Tag标记](./20101_物品编辑器.md#V2背包配置) 的物品会被自动分类到该页签下，判定遵循 [GameplayTag匹配](../../20102_Gameplay标签.md#GameplayTag匹配) 规则；若留空则代表任意物品都允许进入该页签

![image.png](../../../../_assets/images/32901d99_9NsToimage.png)
...
![image.png](../../../../_assets/images/a55602af_BdXgEimage.png)
...
- ItemTag：UI效果影响带指定 [标记Tag](./20101_物品编辑器.md#V2背包配置) 的物品
- Customtypes：UI效果影响指定 [自定义类型](./20101_物品编辑器.md#特性配置) 的物品
- WidgetSoftClassPath：引用的控件蓝图（图例中 ``BP_Grid_Tag`` 蓝图为新建的控件蓝图）

> ItemTag和Customtypes为“逻辑或”的关系

![image.png](../../../../_assets/images/7a50243c_FJBNsimage.png)
![企业微信截图_174290448329.png](../../../../_assets/images/5b406c5e_UCsNX企业微信截图_174290448329.png)
...
- ItemTag：面板效果影响带指定 [标记Tag](./20101_物品编辑器.md#V2背包配置) 的物品
- Customtypes：面板效果影响指定 [自定义类型](./20101_物品编辑器.md#特性配置) 的物品
- WidgetSoftClassPath：引用的控件蓝图

> ItemTag和Customtypes为“逻辑或”的关系

![image.png](../../../../_assets/images/6f4a1606_a7Ghgimage.png)
...
![image.png](../../../../_assets/images/30607e2f_DTk4Fimage.png)
...
![image.png](../../../../_assets/images/4f41d84c_X1qaiimage.png)

半屏样式：

![image.png](../../../../_assets/images/386eecdf_GxI6Timage.png)
...
![image.png](../../../../_assets/images/7cd9eb1e_BiqUaimage.png)

装备类物品：

![image.png](../../../../_assets/images/f108c4ec_sravbimage.png)

已存入仓库的物品：

![image.png](../../../../_assets/images/ac55facf_8UFiuimage.png)

> ``存入仓库`` 和 ``存入背包`` 按钮需要启用仓库（设置带有仓库的背包模式）和启用 [是否持久化](./20101_物品编辑器.md#V2背包属性配置:~:text=背包属性配置-,V2背包属性配置,-类型特性配置) 的物品才会显示

**按钮列表属性**

![image.png](../../../../_assets/images/def57f44_kXnrKimage.png)
...
![image.png](../../../../_assets/images/2bf82345_KN22iimage.png)
...
![image.png](../../../../_assets/images/531f8c38_wrb0Zimage.png)

点击【编译】并【保存】对 ``BP_BackpackUIComponentV2`` 组件的修改，添加能量饮料以及其他对照物品，打开背包点击格子物品，即可观察效果。

![2026-01-1415-48-34-ezgif.com-video-to-gif-converter.gif](../../../../_assets/images/4b3439af_fOb4T2026-01-1415-48-34-ezgif.com-video-to-gif-converter.gif)
...
![image.png](../../../../_assets/images/dd5509fd_jQJYgimage.png)

添加的自定义按钮会在内置按钮后，按自定义列表的顺序进行排列展示。

![image.png](../../../../_assets/images/8b6de0d2_QqmmFimage.png)
...
![image.png](../../../../_assets/images/bb88b742_02j8zimage.png)

对应的品质编号，与【[物品编辑器2.0](./20101_物品编辑器.md)】的 ``物品品质`` 属性配置相关联。

![image.png](../../../../_assets/images/af074eac_2ItWcimage.png)
...
> 有关背包系统所有预设槽位及扩展功能，可参见 [物品与背包槽位](./20210_物品与背包槽位.md)

![image.png](../../../../_assets/images/19422208_k7bE7image.png)
...
![image.png](../../../../_assets/images/9c0fc6e8_TWJs9image.png)
...
- 槽位名称：同属于 [GameplayTag](../../20102_Gameplay标签.md)，但必须为 ``EquipmentSlot`` 下的子级Tag
- 槽位中文名：槽位的名称
- 槽位类型约束：槽位允许装配的 [物品类型](./20101_物品编辑器.md#特性配置)，支持多种类型

![image.png](../../../../_assets/images/0e116a44_TpxI0image.png)

若装备物品类型与槽位类型匹配，则物品可被装配到对应槽位上。

![image.png](../../../../_assets/images/98506eab_uCZWPimage.png)
...
![image.png](../../../../_assets/images/91b9f727_ZnKsNimage.png)
...
![image.png](../../../../_assets/images/09e3eaf7_KgQpXimage.png)
