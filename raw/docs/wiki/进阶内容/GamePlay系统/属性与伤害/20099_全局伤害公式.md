...
全局伤害公式提供了统一定制伤害计算逻辑的入口，以中心化的方式管理全局的伤害处理逻辑，支持接入 [属性系统](./20098_通用属性系统.md) 的复杂伤害计算，且相比于伤害覆写，伤害公式的优先级更高，作为伤害结算的最终输出值。

![image.png](../../../_assets/images/bc5ada50_sqjFsimage.png)

> 对于怪物伤害，伤害公式仅支持 [新怪物系统](../怪物系统/20144_怪物快速配置指南.md)

## 启用伤害公式

编辑器菜单栏中单击 ``属性管理器``，打开属性管理器面板后，选择 ``伤害公式`` 并点击【推导】按钮，将在工程目录 ``Blueprint/Attributes`` 下创建名为“UGCGlobalDamageCalculation”的蓝图。

![image.png](../../../_assets/images/63eafe5c_0xmqbimage.png)
![image.png](../../../_assets/images/aaa7156d_kXNvFimage.png)

同时，会在工程Script脚本目录的相同路径下生成全局伤害公式的类文件，核心的伤害处理逻辑在该类下实现。

![image.png](../../../_assets/images/afd6c09e_LEQvkimage.png)
...
|ExtraResult|伤害的额外信息，通过 [GameplayTag](../20102_Gameplay标签.md) 表示|FExtraDamageCalculationResult|
...
|FExtraDamageCalculationResult|伤害的额外信息，通过 [GameplayTag](../20102_Gameplay标签.md) 表示|
...
![image.png](../../../_assets/images/4aec156c_1TJY6image.png)
