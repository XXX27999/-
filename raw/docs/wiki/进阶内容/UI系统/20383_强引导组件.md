...
![image.png](../../_assets/images/06d01337_Vgorbimage.png)
![image.png](../../_assets/images/431618c3_WGkL7image.png)
2.根据需要强引导的区域，调整好```CanvasPanel_0```的位置和大小，将其```SizeBox_0```框到需要引导的区域处，之后的调用都会固定将框到区域设置成可点击的高亮区
![image.png](../../_assets/images/1c7c2835_pPU2Dimage.png)
...
![image.png](../../_assets/images/89bc57a5_8gwEdimage.png)
...
```
5.实机效果
![2026-05-2618-16-07-ezgif.com-video-to-gif-converter.gif](../../_assets/images/7c08e828_59eCf2026-05-2618-16-07-ezgif.com-video-to-gif-converter.gif)

## 关键控件介绍
- ```SizeBox_0```需要高亮（镂空）的目标区域，其位置大小决定镂空框的位置大小
![image.png](../../_assets/images/401079ca_oB4iaimage.png)
- ```Image_2```中可以指定镂空边框材质
![image.png](../../_assets/images/17fc045c_AKnlrimage.png)
- ```UTRichTextBlock_Tips14_1```富文本控件中可以更改引导所显示的文字
![image.png](../../_assets/images/b16f02dc_nZeVYimage.png)
- ```Border_0```全屏遮罩Border，使用动态材质判断设置遮挡实现镂空效果
![image.png](../../_assets/images/918055c9_gzxq0image.png)
