...
怪物的移动范围取决于 [导航网格](./20266_导航网格.md) 的覆盖面积，通常是在编辑器视口中静态构建，如果希望在游戏运行时能够动态改变怪物的可移动范围，需要遵循指定的配置并调用相应的API来改变导航网格数据。

## 添加导航网格体

更新导航网格数据的前置条件是场景中存在导航网格体组件，可以参考 [创建导航网格体](./20266_导航网格.md#创建导航网格体) 的方式在关卡场景中添加 ``Nav Mesh Bounds Volume`` 组件。

> 导航网格体的覆盖范围需要包含待动态更新的区域，否则无法正常生成

![image.png](../../../_assets/images/776e2fe7_Sy7y3image.png)
...
![image.png](../../../_assets/images/b502a97f_GdObYimage.png)

在 ``Generation`` 属性组下点击【显示高级项】按钮扩展详细列表。

![image.png](../../../_assets/images/270d888d_qZrTYimage.png)
...
![image.png](../../../_assets/images/c739f865_rrenXimage.png)
...
|-|-|
|对于编辑器构建导航网格数据之后创建的平台，运行时未使用全局更新时没有导航网格数据。<br>![image.png](../../../_assets/images/5067ab27_rI84Eimage.png) |对于编辑器构建导航网格数据之后创建的平台，运行时使用全局更新后生成了导航网格数据。<br>![image.png](../../../_assets/images/23aad629_A4NEVimage.png)|

全局更新之前，在未被构建可运行区域的地方怪物无法进行寻路。

![2026-01-2015-39-40-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/0b6654de_SRIN62026-01-2015-39-40-ezgif.com-video-to-gif-converter.gif)

调用接口进行导航网格的更新后，怪物可以进行正常寻路。

![2026-01-2015-39-51-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/176b05ea_UAK3g2026-01-2015-39-51-ezgif.com-video-to-gif-converter.gif)
...
![image.png](../../../_assets/images/4e73bfde_hg6FLimage.png)
...
![企业微信截图_1770868009131.png](../../../_assets/images/35b87075_wAdBc企业微信截图_1770868009131.png)
...
![企业微信截图_17708681194311.png](../../../_assets/images/0c5c90a4_G4DMJ企业微信截图_17708681194311.png)
...
![image.png](../../../_assets/images/5f5f706d_dJktfimage.png)
