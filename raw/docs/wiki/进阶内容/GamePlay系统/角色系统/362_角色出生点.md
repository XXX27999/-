...
![image.png](../../../_assets/images/c1eb5718_yDq1kimage.png)

在模式面板中搜索“PlayerStart”即可找到该蓝图：

![image.png](../../../_assets/images/a5eac920_H1EB8image.png)
...
![image.png](../../../_assets/images/f946eb33_obdLeimage.png)

**蓝图创建**

在工程任意目录下右键点击 ``Blueprint Class``，搜索“PlayerStart”找到该蓝图，选中后即可创建出生点蓝图：

![image.png](../../../_assets/images/aaa11d60_H3ztqimage.png)

以上任意方式获得出生点蓝图后，将该蓝图放置在关卡中合适的位置进行实例化，PlayerPawn会根据该出生点结合指定规则进行出生。

![企业微信截图_1686711110328.png](../../../_assets/images/f6114c56_企业微信截图_1686711110328.png)
...
![企业微信截图_168671112293.png](../../../_assets/images/b836e23f_企业微信截图_168671112293.png)
...
![企业微信截图_16867111639124.png](../../../_assets/images/ef8f1a07_企业微信截图_16867111639124.png)
...
![image.png](../../../_assets/images/8d494741_MfDiVimage.png)

**3. 实现自定义出生规则**

双击打开MyStartManager蓝图，点击组件菜单栏的“Lua”按钮，打开MyStartManage类脚本文件：

![image.png](../../../_assets/images/502b2cdb_2LoOyimage.png)
...
![image.png](../../../_assets/images/69b9d24d_gbLtVimage.png)

![企业微信截图_1686711975945.png](../../../_assets/images/ecaedc31_企业微信截图_1686711975945.png)
