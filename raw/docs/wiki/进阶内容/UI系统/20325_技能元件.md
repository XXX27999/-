...
![ScreenShot_2026-02-28_155817_968.png](../../_assets/images/8618fc90_mbSctScreenShot_2026-02-28_155817_968.png)

在【UI编辑器】中点击【元件】->【技能】->【技能按钮模板】创建技能元件蓝图

![ScreenShot_2026-02-28_155930_411.png](../../_assets/images/3668a3a7_93yS7ScreenShot_2026-02-28_155930_411.png)

## 技能元件结构

![ScreenShot_2026-02-28_144602_706.png](../../_assets/images/fa05504a_GDRprScreenShot_2026-02-28_144602_706.png)
...
![ScreenShot_2026-03-02_153503_476.png](../../_assets/images/efe3a892_4mPAYScreenShot_2026-03-02_153503_476.png)
...
![ScreenShot_2026-03-02_102342_017.png](../../_assets/images/32a9dad8_Qw35PScreenShot_2026-03-02_102342_017.png)
...
![image.png](../../_assets/images/1ef1666a_yFenlimage.png)
...
参照[新建技能蓝图](../GamePlay系统/技能系统/技能编辑器2.0/20091_技能编辑器.md#新建技能蓝图)，进行技能的创建。
点击【技能编辑器】->`技能`->创建好的技能->`默认技能UI`，更改为创建好的“技能元件蓝图”。

![numbered-image-1772442661037.png](../../_assets/images/b0fa1dfd_fFWUdnumbered-image-1772442661037.png)
...
![ScreenShot_2026-04-13_110219_429.png](../../_assets/images/b86e7e24_uVBOBScreenShot_2026-04-13_110219_429.png)

在【技能编辑器】中将毒气手雷技能挂载至下蹲的槽位。

![ScreenShot_2026-04-13_111720_095.png](../../_assets/images/531d18bb_XKlmjScreenShot_2026-04-13_111720_095.png)

在【UI编辑器】选中与冲刺技能绑定的元件蓝图中的最上层的`画布面板`，对其进行平移处理。

![ScreenShot_2026-04-14_095200_746.png](../../_assets/images/a47228e3_CF5KwScreenShot_2026-04-14_095200_746.png)

若复用和平按钮槽不能满足需求，可参照[自定义控件布局](./20019_和平主界面控件布局.md#自定义控件布局)和[贴边型控件](./20269_UI自适应屏幕.md#贴边型控件)创建自定义锚点并做好适配。
参照[添加技能](../GamePlay系统/技能系统/技能编辑器2.0/20091_技能编辑器.md#添加技能)，在`PlayerPawn`蓝图中， 通过`PersistClientStateComponent `技能组件为角色蓝图默认挂载该技能组件。技能UI锚点位置可参照[和平控件锚点](./20097_和平控件锚点.md#技能UI锚点)。

![image.png](../../_assets/images/c11ad336_ILloMimage.png)

## 和平精英模拟器适配

如果你的玩法需要支持PC端,可以配置键盘操作的提示效果。
![image.22.png](../../_assets/images/a9fba2ad_zgYK6image.22.png)
点击【UI编辑器】->【元件】->【技能按钮模板】进行模版的创建，在详细信息中进行相应配置。
![ScreenShot_2026-05-22_102159_710.png](../../_assets/images/7608331b_qiCkgScreenShot_2026-05-22_102159_710.png)
|技能按键提示配置|配置功能|
|-|-|
