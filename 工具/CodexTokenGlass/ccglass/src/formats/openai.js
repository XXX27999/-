...
export const openai = {
  ...
  estimateTokens(body = {}) {
    // Delegate to the shared estimator: it stringifies the whole body, so
    // function_call / function_call_output / reasoning items are counted too.
    // Walking text fields only (the old behavior) undercounted Codex traffic.
