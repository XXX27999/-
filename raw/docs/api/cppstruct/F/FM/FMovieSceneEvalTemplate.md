...
| --- | --- | --- |
| CompletionMode | [EMovieSceneCompletionMode](../../../cppenum/E/EM/EMovieSceneCompletionMode.md) | Enumeration value signifying whether we should restore any animated state stored by this entity when this eval tempalte is no longer evaluated |
