...
![image.png](../../../../_assets/images/f01ee20e_L4awZimage.png)

|属性名|属性说明|
|-|-|
|Slot Name|基于 [GameplayTag](../../20102_Gameplay标签.md) 定义的槽位名，必须为 ``EquipmentSlot`` 下的子级Tag|
...
|默认启用|该槽位是否默认可用，若不勾选则可设置锁定或者隐藏状态，详细见 [槽位锁定与解锁](./20210_物品与背包槽位.md#槽位锁定与解锁) 部分内容|

> 特别注意，如果 ``Allow Types`` 和 ``Allow Tags`` 都留空，代表允许装配任意物品，可能出现枪械作为头盔配件而装备上的效果

当槽位装配了匹配的配件时，将在物品的详情面板的下方扩展显示槽位及该配件的信息。

![image.png](../../../../_assets/images/258b22e0_OJVe5image.png)

同时背包中物品的右上角会显示槽位的装配状态，装配了配件的槽位将显示蓝色。

![image.png](../../../../_assets/images/7769e93c_7LlF0image.png)
...
![image.png](../../../../_assets/images/37bbaadf_0dPnWimage.png)

背包中的物品详情页会按照槽位的配置顺序依序显示各槽位及装配状态。

![image.png](../../../../_assets/images/4dc673d6_dqFZQimage.png)
...
![image.png](../../../../_assets/images/307c4ddd_r94DYimage.png)
...
![image.png](../../../../_assets/images/20a577ff_1c8W4image.png)

背包槽位的锁定配置：

![image.png](../../../../_assets/images/b744d41b_e8wCgimage.png)
...
![image.png](../../../../_assets/images/727c91b3_Ccywfimage.png)
...
![QQ2025827-201148-HD-ezgif.com-video-to-gif-converter.gif](../../../../_assets/images/a23b84f6_F09OKQQ2025827-201148-HD-ezgif.com-video-to-gif-converter.gif)
