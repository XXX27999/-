...
![image.png](../../../_assets/images/9e72735b_FvEjtimage.png)
...
1. 创建方式与火球术大致一致，只是在动作添加 **范围Buff** 时改为生成法术场。
	...
	![image.png](../../../_assets/images/c2fa4a2d_TcLqAimage.png)

2. 在【区域】页签中找到 **空模板** 并创建蓝图模板，在默认场景根组件下添加Box盒体碰撞组件修改为合适大小以及若干粒子组件系统（ParicleSystem）并设置模板为地板燃烧。

	![image.png](../../../_assets/images/fcaec3f5_hLuhOimage.png)
	![image.png](../../../_assets/images/7b6299ee_ysh4Bimage.png)

3. 修改 `OverlapCheckArea` 组件的细节属性。

	![image.png](../../../_assets/images/4762fab1_qAsYAimage.png)
...
![传送.gif](../../../_assets/images/908fab32_kZp7F传送.gif)
...
3. 添加角色技能轨道—— `调用Lua脚本` 并设置Task细节绑定函数，在函数中调用 [`K2_SetActorLocation`](https://developer.gp.qq.com/api/#/searchContent/AActor?classDetailShow=true&path=class%2Fdetail%2FOthers%2FAActor.json&isSelect=1&apiEnc=%5B%22%E7%B1%BB%22%5D&apiLabel=AActor&autoJump=K2_SetActorLocation) 实现位移。
	...
	```
	![image.png](../../../_assets/images/4006e560_BZTGEimage.png)

4. 添加角色技能轨道 `生成粒子` 并修改细节面板中 `粒子模板` 为“传送”，添加角色技能轨道 `播放音效` 并修改细节面板中 `音效` 为“传送发动事件”，角色技能轨道 `播放音效` 并修改细节面板中 `音效` 为“传送落地事件”。为他们设置合理的开始于完成时间。

	![image.png](../../../_assets/images/69633db0_V73RPimage.png)
	![image.png](../../../_assets/images/705750e9_gzsYuimage.png)
...
![火焰冲刺.gif](../../../_assets/images/a2aa649e_BeoIA火焰冲刺.gif)

1. 打开【技能编辑器】，在【技能】页签的“主动技能”的“直接释放型技能”中找到 **冲刺** 并创建技能模板。

	![image.png](../../../_assets/images/ef662f3b_shmMpimage.png)

2. 修改添加 **角色技能轨道** 为：冲刺、生成例子、调用Lua脚本、动态状态变化、追踪目标、选择目标、添加冲量、造成伤害以及若干添加冲量。

	![image.png](../../../_assets/images/ebfc54ae_1ezprimage.png)
...
3. 编辑这个技能蓝图的Lua脚本，选中“调用Lua脚本”修改细节配置。
	...
	```
	 ![image.png](../../../_assets/images/8873c181_92ekuimage.png)

4. 设置“添加冲量”轨道Task细节。

	![image.png](../../../_assets/images/c2f50e8a_lZSlLimage.png)
...
![火焰强化.gif](../../../_assets/images/e16bc962_Esa5K火焰强化.gif)

1. 创建技能模板，添加多个技能阶段，分别为上浮，浮空，落地。

	![image.png](../../../_assets/images/0aee91fc_bSMbJimage.png)

2. 分别为三个阶段设置状态轨道。在上浮阶段添加上浮动画轨道，并添加角色技能轨道调用lua脚本实现无敌和上浮。

	![image.png](../../../_assets/images/ac0e5e74_8O4Pkimage.png)
	``` Lua
		---设置无敌
	...
	![image.png](../../../_assets/images/3c8b898e_Fjs0Simage.png)

	下落阶段除了下落动画之外需要添加一个冲刺Task来实现下落的效果，在下落完成时向四周发射火球抛体，同时需要结束无敌状态。

	![image.png](../../../_assets/images/98c3a65b_LWnMtimage.png)
...
![火球强化.gif](../../../_assets/images/70828af6_jyYEa火球强化.gif)

在【被动技能】页签下找到“空模板技能”，创建技能模板，修改技能配置。所使用的抛体与火焰强化二阶段抛体一致。

![image.png](../../../_assets/images/4ca0dfe9_w4DGXimage.png)
...
![火球召唤.gif](../../../_assets/images/e2cc27bf_KDh3R火球召唤.gif)

创建技能模板并添加相应的动画与“选择点”和“发射抛体”等技能轨道，所发射的抛体创建方式与火球抛体类似，仅修改特效音效为陨石爆炸；修改粒子发射器为陨石(红)。

![image.png](../../../_assets/images/83b26353_8pyjTimage.png)
![image.png](../../../_assets/images/659b2d81_vOFSAimage.png)
![image.png](../../../_assets/images/5fc51d40_xD0ieimage.png)
...
![强化火球召唤.gif](../../../_assets/images/cd3cd49b_ciiY6强化火球召唤.gif)

技能创建方式与陨石坠落一致，只是在创建技能轨道——发射抛体Task时替换抛体蓝图。强化陨石坠落的抛体陨石与普通陨石抛体类似，修改特效和粒子发射器为陨石(绿)，此外还需要添加一个生成法术场。

![image.png](../../../_assets/images/069aee97_833kaimage.png)

毒雾法术场的创建与之前火焰的类似。

![image.png](../../../_assets/images/412ac523_JDcqDimage.png)
...
![召唤小怪.gif](../../../_assets/images/c4b06bd5_l6OMc召唤小怪.gif)
![怪物自杀.gif](../../../_assets/images/52b32beb_O23DZ怪物自杀.gif)

1. 创建主动技能模板。

	![image.png](../../../_assets/images/3af9f69f_RLECfimage.png)

2. 修改技能配置，添加动画轨道和技能轨道。

	![image.png](../../../_assets/images/850d369e_uqMvTimage.png)

3. 创建小怪模板，使用“近战僵尸”和“远程僵尸”作为小怪模板蓝图。

	![image.png](../../../_assets/images/ed2b72d9_b1uqCimage.png)

4. 为刚才创建的小怪添加额外的被动技能，来实现让小怪出生十五秒之后自杀。该技能通过怪物通用被动技能——“亡语-毒谭”作为模板实现。

	![image.png](../../../_assets/images/4711f459_MvRyDimage.png)

5. 修改技能配置。

	![image.png](../../../_assets/images/7df56c8d_XsHT5image.png)

6. 分别为创建的小怪添加被动技能。

	![image.png](../../../_assets/images/ec810f21_7gm6limage.png)

7. 修改技能的角色技能轨道中“生成怪物”的细节面板，将Monster类设为刚才创建的小怪。

	![image.png](../../../_assets/images/5d354fd8_BOPdfimage.png)
...
![怪物自杀2.gif](../../../_assets/images/64fd83aa_3vWip怪物自杀2.gif)

因此只需要在召唤仆从的基础上修改小怪技能，为小怪额外添加一个法术场技能，并且为该法术场技能配置“流血Buff”作为中毒效果。

![image.png](../../../_assets/images/58a49659_jQOKmimage.png)
![image.png](../../../_assets/images/8bb36f22_c1fXSimage.png)
### 添加技能
打开刚刚创建的丧尸法师的技能组件 `PersistClientStateComponent` ，可以发现模板预设了两个技能，分别是“火球术”和“传送”，点击加号可以添加更多的技能，并将刚才创建的技能添加上去。

![image.png](../../../_assets/images/a481a72e_H7HPmimage.png)
![image.png](../../../_assets/images/c436e02d_9hyx7image.png)

槽位Slot0，Slot1，Slot2是用来给技能组使用的，Main为普通技能火球术，Slot3是召唤仆从，Slot4是传送，Slot5是转阶段技能，在二阶段时候Slot5中的技能会替换为二阶段特有的被动技能。开发者可以根据自身需求 [创建技能](../技能系统/技能编辑器2.0/20091_技能编辑器.md#技能创建流程) 并添加技能 。
...
![image.png](../../../_assets/images/5dab8625_INDajimage.png)

另外，其自身受击呼叫支援的范围也有所扩大，变为15m。

![image.png](../../../_assets/images/10be9712_SGmTWimage.png)
...
![image.png](../../../_assets/images/7efede5c_GOBGcimage.png)

#### 转阶段行为

行为树中实现了转阶段逻辑，主要是释放特定的技能和替换一些技能。如果血量少于阈值则会转阶。打开行为树，我们在根节点下面的selector节点中，添加了下面的逻辑。

![image.png](../../../_assets/images/1be4e594_1pRfeimage.png)

在执行一次行为树时候，会先判断当前血量是否低于了配置的数值。此数值在怪物的行为组件中配置。

![image.png](../../../_assets/images/2249c64e_eh1CXimage.png)
![image.png](../../../_assets/images/16379e28_aLIVTimage.png)
...
![image.png](../../../_assets/images/8581b6d4_wBSQ3image.png)
...
![image.png](../../../_assets/images/933a997e_6mOCrimage.png)
...
![image.png](../../../_assets/images/66e76112_kIvotimage.png)
...
+  **近距离传送机制** ：若前面的判断都未通过，则会执行距离检查，若此时距离小于配置的近身传送距离则执行传送逻辑。这样可以实现若玩家很靠近自身，则会自动传送到一个比较远的位置。
	...
	![image.png](../../../_assets/images/17e5cb82_GBCVQimage.png)

+ **保底机制** : 若前面的检查均失败或者行为未成功执行，则会执行一个保底行为,有30%的几率传送到目标前面的一个较远的范围中，有70%的几率等待一定时间。这样保证了顶端的移动逻辑选择节点一定会返回成功。

	![image.png](../../../_assets/images/ab0dccf4_lMSWkimage.png)
...
![image.png](../../../_assets/images/8095084a_2BLlIimage.png)
...
![image.png](../../../_assets/images/0d0fdb80_knaJdimage.png)

### 动画

和模板怪物不同的是，丧尸法师增加了左转和右转动画配置，并且只有转向角度大于135°才会播放动画，这个参数体现在行为树中的转向节点上。

![image.png](../../../_assets/images/4c2978b6_jU2Pkimage.png)
...
![image.png](../../../_assets/images/23466462_QdjvXimage.png)

同时，Boss召唤出的小怪也需要这样设置，小怪也是在实体编辑器中的，默认情况下创建的小怪模板已经设置好了这些小怪的避障逻辑了，无需再次修改。

![image.png](../../../_assets/images/f14987ba_dWLw2image.png)
