...
![image.png](../../../_assets/images/87f886d7_9oP8uimage.png)

怪物蓝图会绑定骨骼网格体，而骨骼网格体中的物理资产可以实现基于骨骼层级的受击判定，精确识别头部、身体、四肢等部位。如果缺乏物理资产就不会产生精确的受击判定。

![ScreenShot_2025-11-14_201325_233.png](../../../_assets/images/d429de00_qZ5WQScreenShot_2025-11-14_201325_233.png)
...
![ScreenShot_2025-11-14_205110_928.png](../../../_assets/images/40b9e400_YQClyScreenShot_2025-11-14_205110_928.png)

如需实现更精细的受击区分（如区分左右手脚），可点击加号添加元素，在左边的键填入对应骨骼部位的名称，右边的值选择对应的部位标签。

![image.png](../../../_assets/images/8bdedcdf_odxeWimage.png)
![image.png](../../../_assets/images/82c12c08_UQ3Ucimage.png)
...
![怪物受击-伤害时序3.drawio.png](../../../_assets/images/b95584a7_PyfBb怪物受击-伤害时序3.drawio.png)
...
![受击部位.gif](../../../_assets/images/e99654de_fmcmE受击部位.gif)
![ScreenShot_2025-11-12_212223_300.png](../../../_assets/images/388cc914_MGdSnScreenShot_2025-11-12_212223_300.png)
...
![image.png](../../../_assets/images/dfbe386e_YI3UWimage.png)

|属性名称|说明|
|:-:|-|
|是否隐藏子弹受击特效|勾选后，怪物被子弹命中时将会隐藏特效，仅对枪械的射线子弹生效|-|
|AI受击特效|选择用于配置受击独立表现的数据资产，配置说明详见 [受击数据资产](../属性与伤害/20169_受击数据资产.md)<br>![特效.gif](../../../_assets/images/9aa81fc3_iamT1特效.gif)|
|伤害冒字|控制受击时是否显示飘字伤害数值<br>![冒字.gif](../../../_assets/images/a2f6e645_N7CN9冒字.gif)|
|延迟隐藏尸体|设定怪物死亡后尸体在场景中保留的显示时间，单位：秒<br>![延迟死亡.gif](../../../_assets/images/1d9a3e2a_Y9Oki延迟死亡.gif)|
...
![image.png](../../../_assets/images/cc49f225_I6985image.png)

例如：使用AKM攻击怪物头部伤害默认为48，修改 ``大脑袋`` 伤害倍率为10倍，配置完成之后编译保存进入游戏即可发现头部伤害从48变为原来的十倍

![image.png](../../../_assets/images/05c10bda_W2WyEimage.png)
