...
- [UBlueprintCore](./UBlueprintCore.md)
...
| NativizationFlag | [EBlueprintNativizationFlag](../../cppenum/E/EB/EBlueprintNativizationFlag.md) | When exclusive nativization is enabled, then this asset will be nativized. All super classes must be also nativized. |
...
| SearchGuid | [FGuid](../../cppstruct/F/FG/FGuid.md) | Guid key for finding searchable data for Blueprint in the DDC |
| bDeprecate | `bool` | Deprecates the Blueprint, marking the generated class with the CLASS_Deprecated flag |
| CompileMode | [EBlueprintCompileMode](../../cppenum/E/EB/EBlueprintCompileMode.md) | The mode that will be used when compiling this class. |
