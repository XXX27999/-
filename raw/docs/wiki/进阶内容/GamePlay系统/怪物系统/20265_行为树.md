...
![image.png](../../../_assets/images/54de62b7_gQaE6image.png)
...
![image.png](../../../_assets/images/e322df3c_mfUYhimage.png)
...
![image.png](../../../_assets/images/7e20b103_zoegyimage.png)
...
![image.png](../../../_assets/images/82371f17_z3t0rimage.png)
...
![image.png](../../../_assets/images/b6a29dfe_hlGYYimage.png)
...
![image.png](../../../_assets/images/2e30dbd0_xroNVimage.png)
...
![image.png](../../../_assets/images/663fbf25_Fq1Ldimage.png)

或者可以通过在行为树编辑器的工具栏上新建黑板创建黑板资源。

![image.png](../../../_assets/images/b49fe38c_S9H3Nimage.png)

**添加键值**

在创建完成后打开黑板资源，单击新键值即可创建你想要类型的键。

![image.png](../../../_assets/images/73f02e6d_3KU3ximage.png)

在创建完键之后可以在黑板详细信息中设置键名和类型。

![image.png](../../../_assets/images/aed1cee7_Fgg2bimage.png)
...
![image.png](../../../_assets/images/721133e7_6travimage.png)

打开创建好的行为树，将刚刚设置好的黑板资源指定为行为树黑板资源。

![image.png](../../../_assets/images/051e0d5c_EsxiRimage.png)
...
![image.png](../../../_assets/images/ef25fa5a_iEwuuimage.png)

你也可以从节点连出引线，然后从快捷菜单选择要添加的节点。

![image.png](../../../_assets/images/4814b527_MXL6Aimage.png)

要从图表中删除节点，请选中该节点（或多个节点）并按下 Delete 键（或右键单击并选择 删除（Delete）。

![image.png](../../../_assets/images/a136813c_z6mVjimage.png)

要编辑节点，请选择该节点，然后即可在详细信息面板中修改其属性。

![image.png](../../../_assets/images/4c2e13bb_B0v3uimage.png)
...
![image.png](../../../_assets/images/274b9832_gkYdrimage.png)

创建的自定义节点会在行为树同名文件夹下创建对应的蓝图类，可以在行为树路径下找到该蓝图类。

![image.png](../../../_assets/images/c8293bde_l6SYqimage.png)

双击打开创建的自定义节点，可以使用蓝图Lua编写自定义节点的逻辑。

![image.png](../../../_assets/images/376c1e10_upsGCimage.png)

编辑完成好点击编译、保存，即可完成自定义节点逻辑的编译。

![image.png](../../../_assets/images/f35a99ae_OPYDIimage.png)

之后就可以在新建节点中找到并使用刚刚编写好的自定义节点。

![image.png](../../../_assets/images/4ff4248e_bN17Rimage.png)
...
在编辑完成行为树之后，通过怪物行为控制组件配置行为树和管理反射的黑板键，详情可见 [基础行为树反射键](./20250_怪物行为控制组件.md#基础行为树反射键)。

![image.png](../../../_assets/images/2b8263d9_2MbDFimage.png)
...
![image.png](../../../_assets/images/e0525c7b_Li2vAimage.png)

创建一个控件蓝图，并创建按钮，为对应按钮添加相应逻辑，

![image.png](../../../_assets/images/d5df76d4_qEB1Uimage.png)
...
![GIF_暂停行为树.gif](../../../_assets/images/876e3ba8_vDxXtGIF_暂停行为树.gif)

点击“恢复行为树“怪物行为将会恢复。

![GIF_恢复行为树.gif](../../../_assets/images/37149f06_PLb5uGIF_恢复行为树.gif)
...
![GIF_修改黑板值.gif](../../../_assets/images/7871f9ca_eL0xdGIF_修改黑板值.gif)
