...
![image.png](../../../_assets/images/82712b2a_YVGDGimage.png)

## 移动策略

移动控制组件提供了4种移动策略：基础移动、飞行移动、群体移动、静止不动，各移动策略适用于不同的应用场景。

![image.png](../../../_assets/images/c9503ad4_tgh2bimage.png)

- Move Tag：当怪物移动时添加的Tag，基于 [GameplayTag](../20102_Gameplay标签.md) 定义的状态标签
...
![image.png](../../../_assets/images/623a4ad8_hq9Rfimage.png)
...
![image.png](../../../_assets/images/b3d856df_UTuQdimage.png)
...
![image.png](../../../_assets/images/ef308513_JINjGimage.png)
...
![image.png](../../../_assets/images/20c977a0_eQuduimage.png)
...
对于场景中的静态物体，当 [构建导航网格](./20144_怪物快速配置指南.md#生成可移动区域) 时会将静态物体的形状和范围参与寻路路径计算，构建结果会自动避开障碍物的区域，怪物的移动范围也将排除这些区域。

![image.png](../../../_assets/images/0eaaca45_z2DZuimage.png)
...
![image.png](../../../_assets/images/154c3769_weJAaimage.png)

目标避障组：

![image.png](../../../_assets/images/6be8fcd3_vLlXqimage.png)
...
![image.png](../../../_assets/images/5c615e2b_23NIGimage.png)

为了验证避障效果，创建另一个怪物蓝图，并将此怪物的移动策略同样设置为 ``基础移动``，开启 ``CrowdMove`` 且 ``默认避障组号`` 设置为1，运行调试游戏可观察怪物的移动避障行为。

![image.png](../../../_assets/images/524e912d_80yVOimage.png)
![QQ2025715-172544-HD-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/024a205e_z3dvlQQ2025715-172544-HD-ezgif.com-video-to-gif-converter.gif)
...
1. 制作一个带有静态网格体的简易障碍物蓝图，并为其添加 ``DynamicObstacleAvoidance`` 组件。
	...
	![image.png](../../../_assets/images/bfe9c689_TuEWEimage.png)

2. 设置动态避障组件的避障相关属性，包含避障策略、避障参考范围、所属避障组和目标避障组等。

	![image.png](../../../_assets/images/e4a0ed32_OVEh4image.png)
	...
	![image.png](../../../_assets/images/986a4794_4lGxUimage.png)

3. 创建一个怪物蓝图，将该怪物设置 ``基础移动`` 策略并启用 ``CrowdMove`` 避障策略，且目标避障组号设为2。

	![image.png](../../../_assets/images/17b7677c_z4exXimage.png)

运行调试游戏，在怪物移动过程中动态生成此障碍物，观察怪物的移动避障行为。

![ezgif.com-video-to-gif-converter.gif](../../../_assets/images/a83a262b_uYj6Mezgif.com-video-to-gif-converter.gif)
...
![image.png](../../../_assets/images/ecb91f50_3hwz4image.png)

## 怪物转向

[[Generic]转向](./20179_任务节点查询手册.md#[Generic]转向) 任务节点能够让怪物执行转向动作以面对指定方向或者目标，通常转向属性在任务节点中配置，移动控制组件中该部分属性为默认初始值。

![image.png](../../../_assets/images/f3a1e833_bHHvgimage.png)
