...
![image.png](../../../_assets/images/987c90d1_yq6bNimage.png)

调整缩放大小，保证可以完全覆盖需要生成的区域，可以在细节菜单栏中调整缩放大小。

![image.png](../../../_assets/images/625c9978_RJQgPimage.png)

或者在视口中选中组件按R键进行缩放调整。

![image.png](../../../_assets/images/0714318c_faKxBimage.png)
...
![image.png](../../../_assets/images/975888de_j88pPimage.png)

构建完成后即可看到生成的导航网格（按P可开关查看）。

![image.png](../../../_assets/images/b8550418_Inj9wimage.png)

Navmesh数据会生成在项目内容下的“Navmesh”文件夹中。开发者可以在内容浏览器中Asset文件夹下找到Navmesh文件夹，右击选择在浏览器中显示打开文件夹找到navmesh数据文件。

![image.png](../../../_assets/images/238d30f5_1uvDlimage.png)
![image.png](../../../_assets/images/3e4ce0a6_G3o0simage.png)
...
![image.png](../../../_assets/images/f9daee37_Od8t8image.png)
