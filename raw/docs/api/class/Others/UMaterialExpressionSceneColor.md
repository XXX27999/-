...
| Input | [FExpressionInput](../../cppstruct/F/FE/FExpressionInput.md) | Based on the input mode the input will be treated as either:<br>	 UV coordinates to apply to the scene color lookup or<br>	 an offset to apply to the scene color lookup, in a 2d fraction of the screen. |
| OffsetFraction_DEPRECATED | [FExpressionInput](../../cppstruct/F/FE/FExpressionInput.md) |  |
