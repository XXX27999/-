...
![image.png](../../../_assets/images/2fbf281b_J4pgEimage.png)

## 创建无骨骼怪物蓝图

在编辑器上方工具栏中打开【实体编辑器】，在【怪物】页签的“怪物模板”类目下找到 **割草怪**，点击打开下拉栏可以看到预置的静态模型怪物模板。

![image.png](../../../_assets/images/7e43e593_c6XTWimage.png)
![image.png](../../../_assets/images/27fedb2f_gOZoIimage.png)

选择其中任意一个模板创建怪物蓝图并打开该蓝图，可以发现在组件列表中没有动画相关的配置内容，并且新增了一个 ```StaticMesh``` 静态网格体组件来作为怪物的模型配置。

![image.png](../../../_assets/images/c3c9a621_2o356image.png)
...
![image.png](../../../_assets/images/f17dbbd4_Az6iEimage.png)
...
![2026-01-2015-26-13-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/b4f76a90_3SGdQ2026-01-2015-26-13-ezgif.com-video-to-gif-converter.gif)
