...
编辑器既有的GamePlay系统功能的实现方式耦合性强、维护成本高，因此以可复用、易扩展为原则对功能进行封装，并提供简单的模块化配置方式，这种形式称为GamePart模块化。目前已有多种功能经过GamePart封装，例如 [商城模板](../商业化及功能模板/20026_商城模板.md)、[排行榜模板](../商业化及功能模板/20048_排行榜模板.md)、[背包系统](../进阶内容/GamePlay系统/物资系统/物资编辑器2.0/20104_背包系统.md) 等等，开发者可按需配置启用且支持调用GamePart的内核接口。
...
![image.png](../_assets/images/5a480b26_8WtPjimage.png)
...
![image.png](../_assets/images/8b46d7cb_1PfLkimage.png)
![image.png](../_assets/images/076db6a0_a7etJimage.png)

同时，UGCGameState蓝图的 ``Game Mode General Config`` 配置属性将自动关联该资产蓝图，保存UGCGameState蓝图以完成GamePart的创建。

![image.png](../_assets/images/c0151570_FWoxhimage.png)
