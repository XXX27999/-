...
![image.png](../../../../_assets/images/de00a79c_sPay5image.png)
...
![image.png](../../../../_assets/images/0dc944df_HvHdUimage.png)
...
![image.png](../../../../_assets/images/58cef830_zmup6image.png)
...
![QQ202409-ezgif.com-video-to-gif-converter.gif](../../../../_assets/images/fba68de6_0T0rKQQ202409-ezgif.com-video-to-gif-converter.gif)

在枪械武器蓝图中的 ``ShootWeaponEntity`` 组件下的 ```Visual Bullet Track Config``` 配置项中，可配置相关属性的参数。

![image.png](../../../../_assets/images/e6cdc67b_ql26kimage.png)
...
![image.png](../../../../_assets/images/32c00a3a_LWWBMimage.png)
...
![image.png](../../../../_assets/images/33ded8dc_311mDimage.png)
![image.png](../../../../_assets/images/17beb16c_cp8qPimage.png)

取消勾选 ```IsSpreadEnable```，即禁用动态准心。

配置完成后，启动调试游戏，装配上对应的枪械，发现设置的准心贴图已生效。

![QQ202409-ezgif.com-video-to-gif-converter (1).gif](../../../../_assets/images/ceb5372d_d5kCLQQ202409-ezgif.com-video-to-gif-converter (1).gif)
...
![image.png](../../../../_assets/images/473d7d80_Ggrbiimage.png)
...
![image.png](../../../../_assets/images/6667e288_m3qpRimage.png)
...
![image.png](../../../../_assets/images/5cbfce6c_3pmHdimage.png)

还可以根据不同的命中部位单独设置伤害比例，``ShootWeaponEntity`` 组件下的 ``PartDamage`` 配置项内即为命中人物不同部位的伤害百分比

![image.png](../../../../_assets/images/72382c83_ybokbimage.png)
...
![image.png](../../../../_assets/images/3b89db17_OszdXimage.png)

枪械武器蓝图中的 ``ShootWeaponEntity`` 组件下的 ``Shoot Config`` 配置项下的 ``Max Bullet Num in One Clip`` 属性即为最大弹匣容量。

![image.png](../../../../_assets/images/d75d64b9_JNBtsimage.png)
