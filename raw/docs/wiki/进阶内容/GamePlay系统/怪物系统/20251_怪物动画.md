...
![QQ2025119-18415-HD-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/631249f5_ihVUiQQ2025119-18415-HD-ezgif.com-video-to-gif-converter.gif)
...
![QQ2025119-181816-HD-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/9b3c16a2_219WqQQ2025119-181816-HD-ezgif.com-video-to-gif-converter.gif)
...
![QQ20251110-15461-HD-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/ad702636_Jy0z9QQ20251110-15461-HD-ezgif.com-video-to-gif-converter.gif)
...
![image.png](../../../_assets/images/3173e679_VoLoNimage.png)
![image.png](../../../_assets/images/34aeec37_PDyjqimage.png)

双击打开动画蒙太奇，在预览区下方的面板中包含蒙太奇编辑、插槽组和片段编辑三部分，蒙太奇编辑用于拼接动画序列资源和创建新片段，默认有“Default”片段，插槽组设置该动画蒙太奇播放时使用的插槽，片段编辑定义不同片段之间播放的衔接方式。

![image.png](../../../_assets/images/b6a9abc0_zdx5Limage.png)
...
![image.png](../../../_assets/images/68eaf7b5_pPxKjimage.png)

将死亡动画序列拖放至Default槽位下，会自动把动画序列填充到Default片段中，预览动画会发现动画编辑器重复播放该动画片段。

![QQ2025119-192322-HD-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/ebab6d2f_K6lIsQQ2025119-192322-HD-ezgif.com-video-to-gif-converter.gif)
...
![QQ2025119-193616-HD-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/2f90e301_lehfaQQ2025119-193616-HD-ezgif.com-video-to-gif-converter.gif)

在片段编辑区的【预览】轨道处点击选中Loop片段，再次点击上方生成的Loop片段将在后面出现 ``X`` 标记，表示该片段播放完成后继续播放同片段，实现了循环播放Loop片段的效果，元素之心的死亡动画蒙太奇即配置完成。

![QQ2025119-195051-HD-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/15c7be6b_bOxdtQQ2025119-195051-HD-ezgif.com-video-to-gif-converter.gif)
...
![image.png](../../../_assets/images/162a2ba0_1aCLjimage.png)
![image.png](../../../_assets/images/e093b03b_LZJpiimage.png)

双击打开混合空间，混合空间1D代表单一维度的混合，移动场景下以移动速度作为输入值，因此混合面板中只有水平轴单轴。

![image.png](../../../_assets/images/21e58365_FLJokimage.png)

水平轴分为3个分区，分别对应速度为0、50和100时要播放的动画，将对应的动画序列资源拖拽到相应的采样点上，元素之心的移动混合空间即配置完成。

![QQ20251110-191816-HD-ezgif.com-video-to-gif-converter.gif](../../../_assets/images/09948782_hRWVoQQ20251110-191816-HD-ezgif.com-video-to-gif-converter.gif)
...
![image.png](../../../_assets/images/6da29ea4_mx2Zfimage.png)
...
![image.png](../../../_assets/images/803824d2_NENwyimage.png)
...
> - 击退动画的触发，取决于对怪物造成的伤害是否配置了 [受击数据](../属性与伤害/20169_受击数据资产.md)，且具备击退的水平/垂直方向上的速度
> - 落地动画播放时，怪物会被强制在原地不动以避免出现滑步问题
> - 由于怪物的攻击行为由技能触发，因此攻击动画需要通过技能编辑器的 [动画轨道](../技能系统/技能编辑器2.0/20094_技能Task查询手册.md#动画表现) 配置

此外该模式提供了部分特化的动画参数供自定义调整：

![image.png](../../../_assets/images/7c02b6e8_V4l0Rimage.png)
...
![image.png](../../../_assets/images/79f15a2a_3ENxeimage.png)
...
> 共享动画模式提供了攻击姿态动画配置，技能编辑器中通过 [技能Task-播放预设动画](../技能系统/技能编辑器2.0/20094_技能Task查询手册.md#技能Task-播放预设动画) 进行关联引用
