...
![image.png](../../_assets/images/67858485_RbbvDimage.png)

### 2. 配置头像内容和头像框
![image.png](../../_assets/images/1b82e5a6_HfBJ5image.png)
|属性名|说明|
|-|-|
...
![image.png](../../_assets/images/c3aa5a99_BWFxOimage.png)
最终效果如下
![image.png](../../_assets/images/d6f2b4c6_PLkxOimage.png)
 > 当头像框组件有参数修改时，放置对应头像框组件的界面也需保存一下，否则修改可能不生效
## 头像框层级说明
头像框组件由头像内容和头像框组成，头像内容可以是图片资产也可以是玩家QQ或微信的头像
![image.png](../../_assets/images/18a79402_kec5zimage.png)
|层名|说明|
|-|-|
