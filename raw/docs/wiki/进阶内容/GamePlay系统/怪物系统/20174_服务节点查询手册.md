...
![image.png](../../../_assets/images/ab2b1850_ZgacBimage.png)
...
寻敌是怪物最基础的行为之一，通常基于距离、仇恨值、感知系统等多维度综合选择出最终目标，由于寻敌模式的通用性，实体编辑器将各要素抽象成不同的逻辑组件，并通过 [怪物逻辑管理组件](./20162_怪物逻辑管理组件.md) 提供参数化配置，开发者无需关注此服务节点的 ``寻敌策略`` 配置。

> 行为树如果使用了该节点，则必须配套为怪物蓝图 [添加逻辑管理组件](./20162_怪物逻辑管理组件.md#添加逻辑管理组件)

![image.png](../../../_assets/images/b1f02e4f_JbJdzimage.png)
...
![image.png](../../../_assets/images/b1cafb26_DTUHEimage.png)

- 新最大速度：覆盖怪物蓝图的移动管理组件下的最大移动速度
	![image.png](../../../_assets/images/f506fb61_LWh6Mimage.png)
