...
![image.png](../../../../_assets/images/b2193d1c_xME49image.png)
...
- ItemID：对应 [物品编辑器2.0](./20101_物品编辑器.md) 中创建物品的物品ID
...
![image.png](../../../../_assets/images/b8f46e1e_xIDs1image.png)

属性读取的完整时序如下：UI系统查询物品名称 → 属性重写回调触发 → 读取 CustomData 获得 DataID → 查询实例数据表 → 返回对应字段值。

![image.png](../../../../_assets/images/25c2123f_yZsEsimage.png)

## 使用说明

### 前置：启用 [V2背包](./20104_背包系统.md#启用背包系统:~:text=大纲-,启用背包系统,-自定义背包) 和 [自定义拾取组件](./20420_自定义拾取组件.md)

点击编辑器菜单栏的【玩法通用设置】按钮，在【GamePart】中添加【GP_BackpackV2】模块和【GP_PickUpV2List】。

![image.png](../../../../_assets/images/7f424f56_YJediimage.png)

### 配置实例数据表

打开【表格管理器】，在【自定义表格】中创建一张数据表，命名为 BattleItemInstance，配置需要重写的属性。

![image.png](../../../../_assets/images/b50cdf80_Srkdlimage.png)
...
![image.png](../../../../_assets/images/f852ffb3_Q0fRLimage.png)

![image.png](../../../../_assets/images/bfa2fea2_sy9rsimage.png)
...
![image.png](../../../../_assets/images/6db483a6_3XW4Qimage.png)

### 通过 GM 工具添加物品

启动 PIE 运行游戏，打开 GM 工具面板，找到 "物品实例" 侧边栏，在输入框中输入 DataID（如 8310048_2），点击添加。

![image.png](../../../../_assets/images/fee8d561_dhDsJimage.png)
...
![image.png](../../../../_assets/images/4bd08001_aEGKKimage.png)

2.选中场景中的 BP_ItemInstanceExample Actor，在变量面板中编辑 DataID

![image.png](../../../../_assets/images/3b44ffde_Ed1b1image.png)
