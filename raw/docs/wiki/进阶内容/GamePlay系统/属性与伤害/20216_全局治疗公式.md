...
类似于 [全局伤害公式](./20099_全局伤害公式.md) 的作用，属性管理器提供了统一定制治疗计算逻辑的入口，以中心化的方式管理全局的治疗处理逻辑，决定所有调用 [``RecoverGenericCharacterHealth``]() 的最终治疗值结果。

![image.png](../../../_assets/images/656796fc_gMdl4image.png)

> 对于怪物治疗，仅 [新怪物系统](../怪物系统/20144_怪物快速配置指南.md) 支持治疗公式

## 启用治疗公式

编辑器菜单栏中单击 ``属性管理器``，打开属性管理器面板后，选择 ``治疗公式`` 并点击【推导】按钮，将在工程目录 ``Blueprint/Attributes`` 下创建名为“UGCGlobalRecoveryCalculation”的蓝图。

![image.png](../../../_assets/images/fb59ae89_ZOgAZimage.png)
![image.png](../../../_assets/images/59a255ff_BygBuimage.png)

同时，会在工程Script脚本目录的相同路径下生成全局治疗公式的类文件，核心的治疗处理逻辑在该类下实现。

![image.png](../../../_assets/images/0f9dd850_AfaEvimage.png)
...
|ExtraResult|治疗的额外信息，通过 [GameplayTag](../20102_Gameplay标签.md) 表示|FExtraDamageCalculationResult|
...
|-|-|
|number|覆写后的最终治疗值|
|FExtraDamageCalculationResult|治疗附带的额外信息，通过 [GameplayTag](../20102_Gameplay标签.md) 表示|
...
![image.png](../../../_assets/images/3c178fbf_b1qjgimage.png)
