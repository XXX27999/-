...
和平精英基于经典“大逃杀”与不断衍生的玩法模式，构建了一系列丰富的 [控件库](./和平控件查询/250_和平主界面控件.md)，方便玩家根据操作习惯与喜好进行个性化设置；而绿洲启元因游戏特性与规则的多样化，开发者常常需要定制UI界面，以适配玩法的操作交互，为了方便开发者对和平控件的控制与布局设置，使用WidgetLayout中间件的方案来提供支持。
...
![image.png](../../_assets/images/968b707c_JAwR4image.png)
...
![image.png](../../_assets/images/73f7b966_iB2vXimage.png)
...
<div style="text-align: center;">
	<img src="../../_assets/images/3ff843f5_KeczD未命名绘图.png"/>
</div>
...
![image.png](../../_assets/images/3e161968_xJvoTimage.png)
![企业微信截图_17420144956100.png](../../_assets/images/52d6481b_S3q0Q企业微信截图_17420144956100.png)
...
![image.png](../../_assets/images/57865de6_QYT4simage.png)

---

### 自定义控件布局

WidgetLayout支持添加自定义的控件并设置控件挂载的 [UISlot锚点](./20097_和平控件锚点.md#UISlot锚点)，方便开发者以可视化的方式控制自定义控件的层级。
...
![image.png](../../_assets/images/c04f54b0_kgqEGimage.png)
...
为了更直观的展示功能，在此使用widget控件蓝图 [新建一个用户界面](./347_快速入门.md)，并添加两个按钮，一个按钮用于加载 ``WidgetLayout`` ，一个按钮用于卸载 ```WidgetLayout```：

![image.png](../../_assets/images/6974301c_Hp8UBimage.png)
...
![QQ录屏20240902104004.gif](../../_assets/images/b19c8ae2_wJ7VYQQ录屏20240902104004.gif)
