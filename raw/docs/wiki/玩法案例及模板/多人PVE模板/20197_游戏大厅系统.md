...
![image.png](../../_assets/images/a3906e70_vAGzhimage.png)

## 英雄选择系统

提供英雄列表展示、解锁验证及角色选择功能，支持技能详情查阅与背景故事展示。

![image.png](../../_assets/images/c40a8152_4EOwGimage.png)

## 模式选择系统

配置多模式入口与难度梯度规则，支持难度选择动态切换，自定义难度解锁逻辑。

![image.png](../../_assets/images/28d085b8_MCOXnimage.png)

## 商城系统

自定义商品内容，实现商品分类展示（道具/武器），包含购买数量调节、异常提示及背包同步机制。

![image.png](../../_assets/images/380c0e2e_ekmPWimage.png)

## 仓库系统

管理仓库与背包的物品流转，支持转移、销毁、代币存取及战斗携带物品持久化规则。

![image.png](../../_assets/images/b28df58c_CSlK7image.png)

## 天赋系统

构建通用与英雄专属双天赋体系，提供加点逻辑、层级解锁、异常提示及英雄天赋重置功能。

![image.png](../../_assets/images/f8c6a112_F7Cagimage.png)

### 天赋类配置表

路径：Asset\Data\Table\TalentTree\UGCTalentCategory

![image.png](../../_assets/images/d31719f2_ygKDKimage.png)
...
![image.png](../../_assets/images/95638658_x4aBqimage.png)
...
每升一等级获得配置的天赋点数，可参考角色 [等级系统](./20198_角色系统.md#等级系统) 的配置说明。

## 玩家信息展示

集成基础数据（等级/头像/性别等）面板与自定义游戏币展示，实时更新核心统计信息（如经验条、等级提升）。

![image.png](../../_assets/images/4a30b59d_fEBvHimage.png)

## 3D大厅系统

整合功能入口，触发待机动作等次要功能，常驻核心信息于屏幕边缘显示。

![image.png](../../_assets/images/060a01be_r0ZXjimage.png)

### 建立场景关卡

1.打开窗口中的"子关卡"

![image.png](../../_assets/images/8a3c3bb9_7bdxpimage.png)

2. 确认玩法主关卡路径：'UGCmap.UGCmap'

![image.png](../../_assets/images/15c96d70_BUHO9image.png)

3. 建立大厅场景子关卡路径：'Asset/Maps/Lobby.Lobby'（右键后选择"关卡"即可创建新的子关卡）

![image.png](../../_assets/images/36ca463e_uW86gimage.png)

4. 加载主关卡，左键点击子关卡将其拖入关卡窗口中的主关卡附属下

![image.png](../../_assets/images/b99763cb_ZVgw3image.png)

5. 将子关卡加载方式改为蓝图

![image.png](../../_assets/images/8fd67f77_RrkEBimage.png)

6. 双击子关卡（出现蓝色字符为正确，意为后续添加的所有actor都归类与该关卡）

![image.png](../../_assets/images/55a5c4ea_BHI5iimage.png)
...
![image.png](../../_assets/images/b0123b03_tpNI8image.png)
...
![image.png](../../_assets/images/913191cb_5nBIaimage.png)
...
![image.png](../../_assets/images/2f585e0a_tMsKYimage.png)

4. 为了防止不同设备分辨率下出现黑边，需要关闭相机的（约束宽高比）选项

![image.png](../../_assets/images/f420e31d_MylnUimage.png)
...
![image.png](../../_assets/images/8f12c589_jaZVzimage.png)

2. 场景灯光属性设置为静态

![image.png](../../_assets/images/94d62dba_8TrKIimage.png)

3. 角色灯光由平行光和天光组件共同照明，平行光有灯光通道可调节，天光则无（平行光属性需要开可移动）

![image.png](../../_assets/images/0eaf5d21_YCvVPimage.png)

4. 因为引擎的灯光逻辑问题，光照通道智能识别单一的最高优先级的通道，所以场景内的所有角色和物件网格都需要把灯光通道统一改成通道0

![image.png](../../_assets/images/5e0fcfe6_kHiV0image.png)
...
![image.png](../../_assets/images/72b4a2d8_ZbrBbimage.png)

2. 新增一个天空盒关卡（需要和开发沟通）将大厅的天空盒复制进来

![image.png](../../_assets/images/309ce476_TmOh6image.png)

3. 将复制的天空盒组件内的平行光关闭

![image.png](../../_assets/images/25ad1308_5obePimage.png)
![image.png](../../_assets/images/d02b9adb_gcbQzimage.png)
