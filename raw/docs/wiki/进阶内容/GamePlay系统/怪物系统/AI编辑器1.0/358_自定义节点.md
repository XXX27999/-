...
![企业微信截图_16873298173096.png](../../../../_assets/images/ba80aeab_企业微信截图_16873298173096.png)

>创建节点后，将在BT同名文件夹下创建对应的蓝图类。建议更换自定义节点蓝图的名字，使其更加符合需求逻辑。

2. 双击打开创建的自定义节点，可以使用蓝图Lua编写自定义节点的逻辑

![企业微信截图_16873298326585.png](../../../../_assets/images/6896b98e_企业微信截图_16873298326585.png)

3. 编写完自定义节点的逻辑，便可以在行为树编辑器使用该节点

![企业微信截图_16967520885570.png](../../../../_assets/images/60a43418_3EKZo企业微信截图_16967520885570.png)
