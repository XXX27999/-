...
属性系统是一套通用的对象属性管理框架，旨在为开发者提供统一、灵活的访问或修改游戏对象（如角色、枪械等）属性的方式，支持创建属性、动态修改属性及构建属性推导逻辑等，属性可应用于 [技能编辑器](../技能系统/技能编辑器2.0/20091_技能编辑器.md)、[Buff编辑器](../技能系统/Buff编辑器2.0/20087_Buff编辑器.md)、[物品编辑器](../物资系统/物资编辑器2.0/20101_物品编辑器.md) 等多类系统功能中。
...
![image.png](../../../_assets/images/51cb4a78_VItSsimage.png)

## 属性管理器

点击绿洲启元编辑器菜单栏的【属性管理器】按钮，将打开属性管理器的操作界面。

![image.png](../../../_assets/images/051edb6c_c1aXSimage.png)

### 属性类别

属性管理器包含多个页签：基础属性、人物属性、武器属性、载具属性、伤害公式与治疗公式，其中 [伤害公式](./20099_全局伤害公式.md) 与 [治疗公式](./20216_全局治疗公式.md) 可以结合属性定制伤害与治疗的计算逻辑，其他四类属性页签功能用于管理不同的适用对象的属性。

- 基础属性：适用于创建通用型属性，挂载 ```属性修改组件``` 的实体对象（包括角色、怪物、载具等）都将拥有这些属性
- 人物属性：此类属性对玩家角色与 [新怪物](../怪物系统/20144_怪物快速配置指南.md) 均生效，适合扩展独有的角色属性
- 武器属性：针对枪械武器的属性定义
- 载具属性：针对载具的属性定义

#### 固化属性

人物属性、武器属性和载具属性均预设了各类对象的部分通用属性，该类属性无法在属性管理器和属性蓝图中修改，但仍然受 ``属性修改组件`` 的覆盖影响，各属性具体的含义可参考 [角色固化属性](./20205_角色属性与状态.md#角色固化属性)、[枪械固化属性](./20159_枪械属性对照表.md) 与 [载具固化属性](./20246_载具属性对照表.md)。

![image.png](../../../_assets/images/d813edc7_AKD0Gimage.png)

#### 自定义属性

在“自定义属性”类别下可以编辑自定义的属性，支持添加、修改、删除等操作，编辑后点击右上方“保存”按钮以保存编辑内容。

![image.png](../../../_assets/images/04e9cade_GQAygimage.png)
...
![image.png](../../../_assets/images/55dfcc9b_BbA6qimage.png)
![image.png](../../../_assets/images/2642d5d3_P8cx8image.png)
...
![image.png](../../../_assets/images/07b234cf_twfDzimage.png)
![image.png](../../../_assets/images/fb022018_3LSGWimage.png)
...
![image.png](../../../_assets/images/fcebf0e1_kgaOqimage.png)
...
![image.png](../../../_assets/images/d9f42e53_xnPzqimage.png)
...
涉及属性的系统通常都通过蓝图配置的方式，提供 [属性绑定](../技能系统/20108_技能属性绑定.md) 或基于 [属性修改器](./20153_属性修改器.md) 的修改属性的功能，例如技能编辑器中的 [角色修改属性](../技能系统/Buff编辑器2.0/20117_BuffAction查询手册.md#修改属性) Task支持修改技能施法者的指定属性值。

> [属性基础值](./20153_属性修改器.md#属性修改器概述) 会受 ``属性修改组件`` 的覆盖影响

![image.png](../../../_assets/images/4626f165_rcYZCimage.png)
...
![image.png](../../../_assets/images/78b94d4c_PmOmDimage.png)

![image.png](../../../_assets/images/77e45473_7QTuDimage.png)

### 最大值属性

一个属性的最大值可以动态绑定到另一个属性上，此时其最大值将随目标属性的实际数值影响。

![image.png](../../../_assets/images/d708a263_INMl2image.png)

#### 计算公式

计算公式固定为 ``属性值 * A + B`` 的计算方法，计算变量支持常数或者float类型的属性绑定。

![image.png](../../../_assets/images/2667893c_a2KQ2image.png)

#### 指定Lua函数

属性修改支持将一个Lua函数注册为伤害计算的回调函数，从而允许在Lua侧通过自定义逻辑来决定伤害结果。

![image.png](../../../_assets/images/e7a84d8c_dHQZoimage.png)
...
![image.png](../../../_assets/images/6f8cc2d6_GwdSsimage.png)
![image.png](../../../_assets/images/7fb27f7c_HdE22image.png)
...
![image.png](../../../_assets/images/61f3806e_uiZSQimage.png)
